...
import com.example.connect.ChatDetailActivity;
...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull UsersAdapter.ViewHolder holder, int position) {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (snapshot.hasChildren()) {
                    for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                        holder.lastMsg.setText(snapshot1.child("msgText").getValue().toString());
                    }
                }
            }
        ...
        // to transfer user info to chat detail activity
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            profilepic = itemView.findViewById(R.id.chatProfileImage);
